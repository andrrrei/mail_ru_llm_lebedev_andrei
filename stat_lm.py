...
class Tokenizer:
    ...
    def build_vocab(self, corpus: List[str]) -> None:
        ...
        for text in corpus:
            ...
            for i in tokens:
                all_tokens[i] += 1
        all_tokens = {word: cnt for word, cnt in all_tokens.items() if cnt >= 5}
...
class GenerationConfig:
    def __init__(self, **kwargs):
        ...
        """
        self.temperature = kwargs.pop("temperature", 0.2)
        self.max_tokens = kwargs.pop("max_tokens", 10)
        self.sample_top_p = kwargs.pop("sample_top_p", 0.0001)
